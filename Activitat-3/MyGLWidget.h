...
class MyGLWidget : public QOpenGLWidget, protected QOpenGLFunctions_3_3_Core {
	...
	public:
  	...
  	//SLOTS:
    	public slots:
        	...
        	void repAngle(int angle);
        	void canviaEstat();
  	//SIGNALS:
    	signals:
        	void teclaT(bool esquerra);
        	void enviaAngle(int angleSnitch);
	protected:
	...
	private:
	    	...
	    	//--------------------------------------------------------------
	    	// uniform locations    
	    	GLuint transLoc, projLoc, viewLoc, llumLoc, posFocusSCALoc, colLoc, translucidLoc, posSnitchDreLoc, posSnitchEsqLoc, colSnitchDreLoc, colSnitchEsqLoc;
	    	//--------------------------------------------------------------
	    	// attribute locations
		...
		//--------------------------------------------------------------
	    	...
	    	// Angles dels snitchs
	    	int AngleSnitch[NUM_ESPELMES], apagarEncendre[NUM_ESPELMES];
	    	// Índex de l'espelma activa
	    	int indexEspelmaActiva;
	    	// Posició del focus fix
	    	glm::vec4 fixaFocusPos;

	    	glm::vec3 llumAmbient, colFocus, posFocusSCA;
