...
QT_MOC_LITERAL(1, 11, 6), // "teclaC"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 8), // "primeraP"
QT_MOC_LITERAL(4, 28, 12), // "canviacamera"
QT_MOC_LITERAL(5, 41, 5) // "value"

    },
    "MyGLWidget\0teclaC\0\0primeraP\0canviacamera\0"
    "value"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->teclaC((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->canviacamera((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGLWidget::teclaC)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyGLWidget::teclaC(bool _t1)
{
